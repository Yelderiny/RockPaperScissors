...
public class RockPaperScissors {
     ...
     */
    public boolean isValidTurn(int turn) { return turn > 0 && turn <= 3; } //true if between 1 and 3
    ...
    public int getPlayerTurn(String input)
    {
        switch (input)
        {
            case "r": return 1; //1 for rock

            case "p": return 2; //2 for paper

            case "s": return 3; //3 for scissors
    ...
    public String getWinner(int playerChoice, int computerChoice)
    {
        ...
        {
            if (computerChoice == 3) return PLAYER; //computer counters with scissors
        ...
        {
            if (computerChoice == 1) return PLAYER; //computer counters with rock
            else return COMPUTER;
        }
        ...
        {
            if (computerChoice == 2) return PLAYER; //computer counters with paper
            else return COMPUTER;
        }
    ...
    public String getTurnAsString(int turn)
    {
        switch (turn)
        {
            case 1: return ROCK; //1 for rock

            case 2: return PAPER; //2 for paper

            case 3: return SCISSORS; //3 for scissors
